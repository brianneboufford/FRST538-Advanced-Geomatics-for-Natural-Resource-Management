...
**Step 4:** Navigate to where the data is saved and click ok. When you can find the data folder, drag-and-drop the **Vancouver_island_dem_filled**  file into the map window. If the mapview does not immediately pan to the data right click **Vancouver_island_dem_filled** in the Contents pane and press Zoom to Layer.
...
**Step 1:** In ArcGIS Pro, add the Vancouver Island boundary to your map project. Clip the DEM to the"vancouver_island_boundary" using the clip raster tool, toggle on "use input features for clipping geometry".  
...
**Step 3:** Navigate to your data folder within the Catalog pane on the right side of your ArcGIS window and drag and drop the **dams** layer onto your Map.
